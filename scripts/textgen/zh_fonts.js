//from https://www.zhangxinxu.com/study/201703/font-family-chinese-english.html
//thanks to zhangxinxu
var dataFont = {
  'windows': [{
    ch: '宋体',
    en: 'SimSun'
...
export let knownZhFonts = []
for (var catag of Object.keys(dataFont)) { for (var entry of dataFont[catag]) { 
  knownZhFonts.push(entry.en)
} }
